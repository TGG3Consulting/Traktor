...
// Migrate накатывает схему через golang-migrate. Идемпотентно.
func Migrate(ctx context.Context, dsn string) error {
	...
	// Своя таблица версий на сервис: при общей базе чужая версия схемы иначе
	// заставит migrate решить, что накатывать нечего.
